 ...
 */
app.controller('hotexchangeCtrl', ['$scope', '_jiyin', 'FileUploader', 'dataToURL', function ($scope, _jiyin, FileUploader, dataToURL) {
    ...
    $scope.save = function (path) {
        _jiyin.dataPost('admin/system_setting_admin/hot_exchange_cover', dataToURL({path: path}))
            .then(function (result) {
    ...
    $scope.get = function () {
        _jiyin.dataPost('admin/system_setting_admin/get_hot_exchange_cover')
            .then(function (result) {
                if(result.success == true){
