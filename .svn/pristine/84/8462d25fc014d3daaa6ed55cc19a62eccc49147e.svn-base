...
<article class="height-full box box-middlecenter">
    <div style="width:300px;text-align:center;">
        <!--svg:start-->
        <svg version="1.1" class="error-svg" viewBox="0 0 1024 1024">
            <g>
        ...
        <!--svg:end-->
        <p class="error-font">网络未连接，请检查网络设置</p>
        <a class="button block submit" style="margin:0px 10px 100px 10px;">重试</a>
    </div>
</article>
