    ...
    <div class="group">
        <div class="tab_nav grid" data-col="2">
            <ul class="slidebar nav_lists">
                <li class="tab {{ (categorys[$index].id == parent.id || (first_active_flag && $index == 0)) ? 'active' : '' }}" ng-repeat="category in categorys" ng-click="get_child_category(category.id, $event)">
            ...
            <ul class="grid" data-col="2" data-rowspace="8">
                <li ng-repeat="recommend in recommends">
                    <div class="product_desc" style="position: relative; background-color: #f9f9f9; padding-bottom: 8px">
                        ...
                        <p >{{recommend.name}}</p>
                        <span class="price">¥&nbsp;<font style="font-size: 18px;">{{recommend.price}}</font></span>
