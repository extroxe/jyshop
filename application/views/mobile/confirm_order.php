            ...
            <div class="inputbox" style="display: flex;" ng-repeat="row in settlement">
                ...
                <div class="info-box">
                    ...
                    <div class="info-price" ng-if="row.is_point == 0">
                        ...
                        <span class="old-price" ng-if="row.flash_sale_price" ng-bind="'¥'+row.price"></span>
                    </div>
                </div>
                <div class="item-num">
                    <span>X</span>
    ...
    <div class="confirm-order-footer">
        <div class="item-total">
            <div style="{{ settlement[0].is_point == 1 ? 'margin-top:12px;' : '' }}">
                ...
                <span style="color: #F6BF00;vertical-align: bottom;" class="total_price" ng-if="settlement[0].is_point == 0">¥ {{ settlement | sum_price : discount.privilege }}</span>
            </div>
